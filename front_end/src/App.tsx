...
import Profile_Courier from './screens/Profile/Profile_Courier';
import ReceiverList from './screens/ReceiverList/ReceiverList';
        ...
        <IonRouterOutlet id="primary">
          ...
          {currentUser 
            ...
            (
              ...
              <Profile />
              :
              (showCourierView && <Profile_Courier />)
            )
            }
          </Route>
          ...
          <Route path="/offer/:id" children={<Offer />} />

          <Route path="/receiverlist" children={<ReceiverList />} />
